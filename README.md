...
## Модели данных (Классы)
  ...
  **Хранение товаров, которые можно купить в приложении**
  ...
  | getProductById      | string(IProduct['id']) | IProduct       | получение одного товара по его id                          |
  ...
  **Хранение товаров, которые пользователь выбрал для покупки**
  ...
  | addItem         | IProduct               | void           | добавление товара, который был получен в параметре, в массив корзины       |
  | removeItem      | string(IProduct['id']) | void           | удаление товара по id, полученного в параметре из массива корзины          |
  ...
  | isAvailable     | string(IProduct['id']) | boolean        | проверка наличия товара в корзине по его id, полученного в параметр метода |
